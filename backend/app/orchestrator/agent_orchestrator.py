...
class AgentOrchestrator:
    def __init__(self, intent_classifier, chat_repo, advanced_agent, basic_agent, vector_repository):
    ...
    async def run(self, user_id: str, body: AIQuerySchema):
        ...
        docs = await self.vector_repository.get_docs(needs_retrieval, prompt=body.prompt)
